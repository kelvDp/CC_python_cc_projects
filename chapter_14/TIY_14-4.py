...
class AlienInvasion:
    ...
    def run_game(self):
        ...
        while True:
            ...
            # self and the name of the method
            self._check_events()  # --> helper method from above
            # To further simplify run_game(), we’ll move the code for updating the screen to
            # a separate method called _update_screen():
            # self.screen.fill(self.bg_color)
            # self.ship.blitme()
            # pygame.display.flip()
